...
#define MODULE_NAME "DDAugmented"
#define LOCTEXT_NAMESPACE "FDDAugmentedModule"

void FDDAugmentedModule::StartupModule()
{
...
void FDDAugmentedModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FDDAugmentedModule, DDAugmented)
